...
frente e mostrava justamente essa, escondendo a causa real ("Aba 'RECEBIMENTO'
não existe em RECEBIMENTO.xlsx"). O usuário via só "os dados não puderam ser
...
== 1/7 De-Para
========================================================
ERRO ao ler as planilhas: Aba 'RECEBIMENTO' não existe em RECEBIMENTO.xlsx e nenhuma outra aba tem o cabeçalho esperado. Disponíveis: ['Planilha1', 'Planilha2']
...
== 2/7 Fatos (ETL)
FALHOU em '2/7 Fatos (ETL)': Planilha não encontrada: D:\\x\\Planilhas\\RECEBIMENTO.xlsx
...
class TestUltimoMotivo(unittest.TestCase):
    def test_prefere_a_causa_ao_passo_que_abortou(self):
        ...
        self.assertIn("RECEBIMENTO.xlsx", motivo)
