"""
core/utils.py — utilitários genéricos da área "Recebimento" (sem Streamlit).
...
def build_row_hash(fields: list, occurrence: int = 0) -> str:
    """
    SHA-1 determinístico do conteúdo de uma linha de recebimento + índice de
    ocorrência.

    O ``occurrence`` distingue linhas 100% idênticas dentro do MESMO arquivo
    (ex.: dois recebimentos físicos iguais): a 1ª recebe occurrence=0, a 2ª
